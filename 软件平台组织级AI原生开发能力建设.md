...
更深一层看，个体 10x 不等于组织 10x。前面我们举的1890 年代纺织厂的例子：工厂换上了电动机，但没有重新设计厂房布局和生产流程，导致电气化后 30 年产出几乎零增长——**我们用AI相当于也是换上了"电动机"，但"工厂"还没有重新设计**。
...
我们期望在今年（2026年），软研的成熟度整体达到2级，部分试点项目达到3级；到2027年能够整体达到3级。
...
如前所述，无论大华内部还是行业，AI在开发领域的应用已经是普遍的事实，对于质量的保障无论从效果上还是速度上，都已经变成一个紧迫的现实。与此同时，测试团队面临的不仅是工作量的压力，更是角色存续的根本挑战。仅仅精通点击界面和维护Selenium脚本的传统手工或初级自动化测试人员，正面临被系统淘汰的深重危机。
...
| "慧码"社区化运作启动                     | 流程引擎 | 公共仓库建立；准入标准、角色定义、生命周期机制发布；首批项目入驻                                                          | 中   | 人力、架构、所有团队 | 7月                   |
